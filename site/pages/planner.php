    ...
    <section class="app-panel p-4">
      <div class="mb-3 flex items-center justify-between gap-3">
        <div>
          ...
          <p id="planner-breakdown" class="mt-1 text-sm app-muted">0<span class="font-bold text-sky-400">P</span> &middot; 0<span class="font-bold text-amber-300">G</span> &middot; 0<span class="font-bold text-slate-300">S</span> &middot; 0<span class="font-bold text-orange-300">B</span></p>
        </div>
